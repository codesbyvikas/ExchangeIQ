...
const Signup = () => {
  ...
  return (
    <div className="h-dvh w-full flex justify-center items-center bg-[#F0F4F8]">
      <div className="p-6 bg-white rounded-lg flex flex-col items-center gap-4 shadow-md">
        <img className="w-40 h-20 object-contain" src={Logo} alt="ExchangeIQ Logo" />
        <h2>Welcome to <span className="font-bold text-xl text-[#3178C6]">ExchangeIQ</span></h2>
        
        <button
          onClick={handleGoogleAuth}
          className="px-3 py-2 font-semibold border-2 border-[#818181] rounded-lg flex items-center gap-3 cursor-pointer hover:bg-[#3179c633] transition"
        >
        ...
        <p className="text-xs text-center text-gray-400">
          By continuing, you agree to our <span className="underline cursor-pointer">Terms of Service</span> and <br />
